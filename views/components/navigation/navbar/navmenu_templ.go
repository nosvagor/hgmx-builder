		...
		if links != nil {
			...
			if len(*links) > 0 {
				for _, link := range *links {
					...
					templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "\" class=\"text-xl font-medium transition-colors page-link font-display text-secondary-300 hover:text-primary-400\">")
					if templ_7745c5c3_Err != nil {
						return templ_7745c5c3_Err
					}
			...
			if settings != nil {
				templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 7, "<div class=\"flex flex-col items-end gap-4\"><button hx-get=\"")
				if templ_7745c5c3_Err != nil {
					return templ_7745c5c3_Err
				}
			...
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 10, "</div></expandedNavMenu>")
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
		}
