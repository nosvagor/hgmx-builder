...
func (p *Props) variant() string {
	switch p.Variant {
	case Primary:
		return "hover:text-primary-401 active:text-primary-401"
	case Destructive:
		return "text-delete-301 hover:text-delete-501 hover:text-delete-501"
	case External:
		return "hover:text-link-401 active:text-link-401"
	case Special:
		return "hover:text-yellow-500 active:text-yellow-500"
	default:
		return "hover:text-yellow-500 active:text-yellow-500"
	}
}
...
func (p *Props) hyprscript() string {
	return `on mouseenter or mousedown or touchstart queue none send hovered to first <svg/> in me then wait 500ms`
}
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if len(p.Href) > 0 {
			templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
				...
				if templ_7745c5c3_Err != nil {
					return templ.Error{Err: templ_7745c5c3_Err, FileName: `views/components/button/render.templ`, Line: 1, Col: 0}
				}
